  ...
  return (
    <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full z-50">
      <div className="relative top-10 mx-auto p-5 border w-11/12 max-w-7xl shadow-lg rounded-md bg-white">
        ...
        <div className="flex justify-between items-center mb-6">
          <div>
            <h3 className="text-xl font-semibold text-gray-900 flex items-center">
              ...
              Multi-Document AI Analysis Results
            </h3>
        ...
        {result.auto_population_data && onApplyAutoPopulation && (
        ...
        <div className="flex justify-between items-center mt-6 pt-4 border-t">
          ...
          <div className="flex space-x-3">
            ...
            <button
              onClick={onClose}
              className="bg-indigo-600 hover:bg-indigo-700 text-white text-sm font-medium py-2 px-4 rounded-md transition-colors duration-200"
            >
              Close
            </button>
          </div>
