...
export const LocationMappingGroup = () => {
  ...
  const handleInputChange = (field: string, value: any) => {
    // Update the location_details structure properly
    const updatedLocationDetails = { ...locationData };
    
    if (field === 'latitude' || field === 'longitude') {
      updatedLocationDetails.coordinates = {
        ...updatedLocationDetails.coordinates,
        [field]: value
      };
    } else if (field === 'district' || field === 'province') {
      updatedLocationDetails.components = {
        ...updatedLocationDetails.components,
        [field]: value
      };
      // Also set at the top level for compatibility
      updatedLocationDetails[field] = value;
    } else {
      updatedLocationDetails[field] = value;
    }
